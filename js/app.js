...
function setupAuthListeners() {
  ...
  async function performLogin() {
    ...
    try {
      ...
      if (!client) throw new Error('Supabase client chưa sẵn sàng. Hãy tải lại trang.');
  ...
  // Mở khóa bằng nút
  if (unlockBtn) unlockBtn.addEventListener('click', performLogin);
